...
public class Serializer {
    ...
    public Serializer() {
        ...
        //There are setups which add synthetic fields to the java classes generated by the codegen tool
        //One example is Jacoco, adding a String[] $jacocoData field, causing the serialization to fail
        //For now, ignore serialization of all String[] fields -- ideally, ignore all synthetic fields!
        //TODO: Find way of ignoring fields by using Field.isSynthetic() instead of ignoring classes
        mapper.addMixIn(String[].class, IgnoreTypeMixIn.class);
    }
